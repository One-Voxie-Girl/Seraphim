 ...
 */
if ( ! function_exists( 'wmcc_acf_save_post' ) ) {
    add_action( 'save_post', 'wmcc_acf_save_post' );
    function wmcc_acf_save_post( $post_id ) {
        ...
        if ( $post_type == 'acf' || $post_type == 'acf-field-group' ) {
            global $wpdb;            
