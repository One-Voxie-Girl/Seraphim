...
<footer class="site-footer bg-peach">
  <div class="container-fluid d-flex flex-wrap justify-content-between align-items-center">
      ...
      <script type="text/javascript" src="https://widget.clutch.co/static/js/widget.js"></script> <div class="clutch-widget" data-url="https://widget.clutch.co" data-widget-type="2" data-height="45" data-nofollow="false" data-expandifr="true" data-clutchcompany-id="1838273"></div>


  </div>
  <div class="container-fluid footerNavCon d-flex flex-wrap justify-content-between align-items-top">

      <div class="footerNav d-flex flex-wrap justify-content-between align-items-top">
        <ul>
          <li><a href="/agency/">Agency</a></li>
          <li><a href="/work/">Work</a></li>
          <li><a href="/carebrand/">CareBrand</a></li>
        ...
        <ul> 
          <li>Process</li>
          <li><a href="/process/discovery/">Discovery</a></li>
          <li><a href="/process/define/">Define</a></li>
          <li><a href="/process/design/">Design</a></li>
          <li><a href="/process/deliver/">Deliver</a></li>
          <li><a href="/process/defend/">Defend</a></li>
        </ul>
        <ul class="socialLinks"> 
          <li><a href="https://www.instagram.com/makeus.care/" target="_blank"><img src="/wp-content/themes/make-us-care-3-0/assets/img/instagram_black.svg" /></a></li>
          <li><a href="https://www.linkedin.com/company/make-us-care/" target="_blank"><img src="/wp-content/themes/make-us-care-3-0/assets/img/linkedin_black.svg" /></a></li>
        </ul>
      </div>
  ...
  <div class="container-fluid footerFine d-flex flex-wrap justify-content-between align-items-center">
    
      <div>
        Make Us Care Group Ltd &copy; <?php echo date('Y'); ?>
      </div>
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const megaInner = document.querySelector(".mega-menu .mega-inner");
  const navItems = document.querySelectorAll(".navbar-nav > li.menu-item-has-children");

  if (!header || !megaMenu || !megaInner || navItems.length === 0) {
    console.warn("Mega menu setup incomplete — check header structure.");
    return;
  }

  let activeItem = null;

  const openMegaMenu = (menuItem) => {
    ...
    // Close any previously active item
    ...
    clone.classList.add("mega-content");
    megaInner.appendChild(clone);

    // Fade-in
    header.classList.add("menu-open");
    megaMenu.classList.add("active");
    requestAnimationFrame(() => megaMenu.classList.add("visible"));
  };
  ...
  const closeMegaMenu = () => {
    ...
    setTimeout(() => megaMenu.classList.remove("active"), 300);
  };
