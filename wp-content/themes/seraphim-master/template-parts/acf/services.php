...
$word        = 'this'; //get_sub_field('moving_text_word'); // e.g. "Our Services"
$moving_text = get_sub_field('moving_text');      // yes/no toggle
...
<?php if ( $moving_text === "yes" && !empty($repeated) ) : ?>
...
jQuery(document).ready(function($) {
  $(document).on("scroll", function() {
    ...
    $(".text-path").attr("startOffset", (percent * 40) - 2000);
  });
});
</script>
